...
import { Tabs, Tab, Box, ThemeProvider, Button } from '@mui/material';
      ...
      <ThemeProvider theme={theme}>
        ...
        <div className='tradingBox-left-main'>
          ...
          <div className='tradingBox-left_inputs'>
            <MyTextField label='ارزش کل' type='تومان' />
            <MyTextField label='مقدار طلا' type='گرم' />
          </div>
        </div>

        <div className='tradingBox-left-btn'>
          <Button
            style={{ border: '3px solid #f1ab1fa5', borderRadius: 8 }}
            size='large'
            fullWidth
            variant='outlined'
            color='primary'
