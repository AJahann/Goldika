...
export default function ArticleNews() {
  return (
    <div className='sec-articleNews'>
      <h2>اخبار و مقالات</h2>
      <div className='articleNews-wrap'>
        <div className='articleNews-card'>
          <a href='/'>
            <div>
              <img src='./images/articleNews/baner1.webp' alt='whyUseGoldika' />
            </div>
        ...
        <div className='articleNews-card'>
          <a href='/'>
            <div>
              <img src='./images/articleNews/baner2.webp' alt='whyUseGoldika' />
            </div>
        ...
        <div className='articleNews-card'>
          <a href='/'>
            <div>
              <img src='./images/articleNews/baner3.webp' alt='whyUseGoldika' />
            </div>
            <h3>
