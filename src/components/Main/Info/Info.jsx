      ...
      <div className='info-right'>
        <div className='info_txt'>
          ...
          <p>
            ...
            کارمزد و بدون محدودیت در مبلغ و زمان را فراهم آورده. طلای شما به
            صورت فیزیکی تامین شده و همراه با فاکتور رسمی قابل تحویل است.
          </p>
        </div>
          ...
          <MultiActionAreaCard>
            ...
            >
              ...
              <Typography
                ...
                color='text.secondary'
              >
                تنها برای اصل طلا پول پرداخت کنید. با خرید طلای آبشده از گلدیکا
                هزینه‌ای برای اجرت ساخت و مالیات بر ارزش افزوده پرداخت نمی‌کنید.
              </Typography>
            </CardContent>
            <CardActions className='info-card-btn'>
              <Button size='small' color='primary'>
          ...
          <MultiActionAreaCard>
            ...
            >
              ...
              <Typography
                ...
                color='text.secondary'
              >
                در گلدیکا امکان معامله آنلاین، سریع، شبانه روزی و بدون وقفه (حتی
                در ایام تعطیلی بازار) فراهم گردیده است. در نتیجه مشتری می تواند
                در هر زمان و هر مکان، در کمتر از دو دقیقه و با هر سطحی از دارایی
                (حتی با ۵۰ هزار تومان) طلا خریداری کند.
              </Typography>
            </CardContent>
            <CardActions className='info-card-btn'>
              <Button size='small' color='primary'>
